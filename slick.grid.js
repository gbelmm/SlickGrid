...
(function($) {
    ...
    function SlickGrid(container,data,columns,options) {
        ...
        function init() {
            ...
            scrollbarDimensions = measureScrollbar(); // skip measurement if already have dimensions
        ...
        function autosizeColumns() {
            ...
            while (total > availWidth) {
                ...
                for (i = 0; i < columns.length && total > availWidth; i++) {
                    ...
                    shrinkSize = ( shrinkSize < 0 ) ? shrinkSize * -1 : shrinkSize;
                    total -= shrinkSize;
                    widths[i] -= shrinkSize;
                }
            }
        ...
        function appendRowHtml(stringArray, row) {
            ...
            stringArray.push("<div class='no-ui-widget-content " + rowCss + "' row='" + row + "' style='top:" + (options.rowHeight*row-offset) + "px'>");
            //stringArray.push("<div class=' " + rowCss + "' row='" + row + "' style='top:" + (options.rowHeight*row-offset) + "px'>");
